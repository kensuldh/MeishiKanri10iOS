...
final class DBService {
    ...
    private let dbFile = "UriDB.sqlite"
    ...
    private func createTable() -> Bool {
        let createSql = """
        CREATE TABLE IF NOT EXISTS uridb (
    ...
    func insertUriDB(uri: Uri) -> Bool {
        ...
        sqlite3_bind_int(insertStmt, 1,Int32(uri.ID))
        sqlite3_bind_text(insertStmt, 2, (uri.Name as NSString).utf8String, -1, nil)
        sqlite3_bind_text(insertStmt, 3, (uri.UriText as NSString).utf8String, -1, nil)
        sqlite3_bind_text(insertStmt, 4, (uri.Biko as NSString).utf8String, -1, nil)
    ...
    func updateUriDB(uri: Uri) -> Bool {
        ...
        sqlite3_bind_text(updateStmt, 1, (uri.Name as NSString).utf8String, -1, nil)
        sqlite3_bind_text(updateStmt, 2, (uri.UriText as NSString).utf8String, -1, nil)
        sqlite3_bind_text(updateStmt, 3, (uri.Biko as NSString).utf8String, -1, nil)
        sqlite3_bind_int(updateStmt, 4, Int32(uri.ID))
    ...
    func getUriDB(ID: Int) -> (success: Bool, errorMessage: String?, uri: Uri?) {
        ...
        if sqlite3_prepare_v2(db, (sql as NSString).utf8String, -1, &stmt, nil) != SQLITE_OK {
            return (false, "Unexpected error: \(getDBErrorMessage(db)).", uri)
        }
    ...
    func deleteUriDB(ID: Int) -> Bool {
        let deleteSql = "DELETE FROM uridb WHERE id = ?;";
